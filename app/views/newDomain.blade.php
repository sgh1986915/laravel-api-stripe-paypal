...
@section('title', 'Newly Registered Domain Name Lists - Whois API')
@section('description', 'Whois API provides Newly Registered Domains and Just Expired Domains as daily downloads. Visit our website and view the sample data.
')
@stop
...
<div class="main-content">
	...
	<div class="row wa-page-title-content-bg">
		<div class="col-xs-12 wa-about-whoisApi wa-auto-margin">
			<h1 class="text-center wa-title wa-title-newDomain wa-title-newregister-newDomain">New Registered Domains</h1>
		</div>
	</div>
					...
					<div class="row">
						<div class="col-xs-12 wa-box-margin-whoisapi">
							<div class="wa-box wa-box-xs-padding wa-box-newDomain wa-box-listnewregister-newDomain wa-top-content-margin">
								<h3 class="wa-section-title wa-section-title-newDomain wa-section-title-listnewregister-newDomain text-center">List of New Registered & just expired domains</h3>
								<div class="wa-content-text wa-content-spacing wa-content-text-newDomain wa-content-listnewregister-newDomain">We provide Newly Registered Domains and Just Expired Domains as daily downloads. <span class="wa-link wa cursor wa-textDecoration">{{ HTML::link('/', 'Whois data') }}</span> are also provided as an option.   Supported TLDs are ".com, .net, .org, .us, .biz, .mobi, .info, .pro, .coop, .asia, .name, .tel, .aero" plus <span class="wa-link wa cursor wa-textDecoration">{{ HTML::link('https://www.whoisxmlapi.com/support/supported_ngtlds.php', 'hundreds of new gTLDs!') }} </span>.    Simply check the edition you want and click on next to purchase.
								<p class="wix-view-sample-wrapper wa-content-text"><span class="sample-data-download">View the</span> <span class="wa-link wa cursor wa-textDecoration">{{ HTML::link('http://bestwhois.org/domain_name_data/sample/', 'sample data here') }}  </span></p>
								 </div>

								<input type="hidden" name="order_type" value="domain_data">
								<div class="wa-content-text wa-subs-plans-newDomain">BELOW PRICING IS FOR MONTHLY SUBSCRIPTION PLANS ONLY</div>
								<div>
									<table class="table table-bordered table-striped wa-content-text wa-content-text-newDomain wa-table-newDomain wa-table-listnewregister-newDomain">
										<thead>
											<tr>
												...
												<?php for($i=0;$i<count($spks);$i++) {
													...
													?>
													<th>
														<input type="radio" name="data_edition" class="wa-input-radio-table" id="wa-optionsRadios1-th-newDomain" value="{{ $i }}" {{ ($spk_sel == 0) ? 'checked' : ''}}>
										...
										<tr class="wa-table-trheight">
											<td>Price/Month</td>
											<?php
											for($i=0;$i<count($domainNameDataPrices);$i++) {
				...
				<div class="row wa-licenseterms-newdomain">
					<div class="col-sm-12 col-xs-12 wa-box-width-xs wa-box-margin-whoisapi">
						<div class="wa-box wa-box-xs-padding wa-box-newDomain wa-box-paymentoption-newDomain">
							<h3 class="wa-section-title wa-section-title-newDomain wa-section-title-paymentoption-newDomain text-center">Payment options</h3>
							...
							<div class="wa-box wa-box-margin-whoisapi wa-box-payandsave-newDomain wa-payyearly-checkbox checkbox wa-content-text wa-content-spacing wa-content-text-newDomain wa-content-text-payyearly-newDomain  ">
								<label>
									<input type="checkbox" name="pay_yearly" value="1">Pay yearly and save <?php echo $domainNameDataYearlyDiscount*100; ?>% (<span id="yearly_price"><?php echo $yearlyPriceDisplay?></span>)
								</label>
							</div>

							<div class="col-xs-12">
								<div class="pull-right"><button type="submit" class="btn btn-default submit-button wa-btn wa-btn-orange wa-btn-next-newDomain wa-btn-newDomain" id="wa-btn-next-newDomain">Next</button></div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-12 col-xs-12 wa-box-margin-whoisapi wa-box-width-xs wa-licenseterms-newDomain">
						<div class="wa-box wa-box-xs-padding wa-box-newDomain wa-box-licenseterms-newDomain ">
							<h3 class="wa-section-title wa-section-title-newDomain wa-section-title-licenseterms-newDomain text-center">License terms</h3>
				...
				<div class="row wa-licenseterms-newdomain">
					...
					<div class="col-xs-12 wa-box-margin-whoisapi wa-box-width-xs">
						<div class="wa-box wa-box-xs-padding wa-box-newDomain wa-box-paymentsecurity-newDomain  wa-bottom-content-margin">
							<h3 class="wa-section-title wa-section-title-newDomain wa-section-title-paymentsecurtiy-newDomain text-center">Payment security and policy</h3>
