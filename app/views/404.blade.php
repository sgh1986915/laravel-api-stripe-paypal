...
<div class="main-content">
	...
	<div class="row wa-page-title-content-bg">
		<div class="col-xs-12 wa-about-whoisApi wa-auto-margin">
			<h1 class="text-center wa-title wa-title-Sitemap">Error 404 - Not Found</h1>
		</div>
	</div>
		...
		<div class="row wa-content-bg wa-content-bg-Sitemap">
			<div class="col-xs-12 wa-auto-margin wa-col-xs-no-padding">
				<div class="wa-box wa-box-xs-padding wa-top-content-margin wa-bottom-content-margin wa-box-link-Sitemap wa-box-Sitemap">
					<div class="text-center wa-404-msg">
						We're very sorry, but that page doesn't exist or has been moved. Please make sure you have the right URL.
					</div>
					<div class="text-center wa-404-sitemap-msg">
						If you still can't find what you're looking for, try the below sitemap.
					</div>
					<ul>
