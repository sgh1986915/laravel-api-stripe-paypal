...
<p class="rightTxt3">
	We offer 2 pricing models for bulk reverse whois credits, <a class="ignore_jssm" href="#pay_as_you_go">pay as you go</a> or <a class="ignore_jssm"  href="#monthly_memberships">monthly memberships</a>. 
	Each 10,000 domains in a reverse whois lookup result cost 1 reverse whois lookup credit.
</p>
<form action="bulk-rw-order_process.php" class="ignore_jssm">
...
<table cellspacing="1" cellpadding="7" border="0" class="colored" align="center">
			  ...
			  <?php for($i=0;$i<$rwQueryCount;$i++){
				...
				?>
              	<tr>
              		<td align="right" class="<?php echo $cl?>"><input type="radio" value="<?php echo $rwQueryAmount[$i];?>" name="query_quantity" <?php echo $checked?"checked":"";?> /></td>
			...
			$cl = ($i%2==0?"evcell":"oddcell");	?>			
		      <tr>
                	...
                	<td align="right" class="<?php echo $cl?>">><?php echo number_format($rwQueryAmount[$rwQueryCount-1])?></td>
              	...
              	<tr>
                	...
                	<td align="right" class="<?php echo $cl?>">
        				...
        				<b>$<?php echo $rwMembershipPrices[$rwMembershipAmount[$i]]?></b> 
            				<input type="submit" value="Bill Monthly" class="mbutton" name="<?php echo 'bill_monthly_' . $rwMembershipAmount[$i] ?>"/>  
                	...
                	<td align="right" class="<?php echo $cl?>">
        				...
        				<?php } else{?>
            				<input type="submit" value="Bill Yearly" class="mbutton" name="<?php echo 'bill_yearly_' . $rwMembershipAmount[$i] ?>"/>   
						<?php }?>
					</td>
