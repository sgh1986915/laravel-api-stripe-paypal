...
<div class="rightTxt2" style="font-weight:bold">
	<?php if($order_type=='report'){?>
		Your order has been processed.  Please login using the account username that you ordered for, click on "Reverse IP" on the top, and then click on "My Reverse IP Reports" on the left to see
		your reports.
		
	<?}
	else if($order_type=='credit'){?>
		Your order has been processed.  Please login using the account username that you ordered for and start using Reverse IP searches to utilize your credits.
	<?php 
	}
	else{?>
