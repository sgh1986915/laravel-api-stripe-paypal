			   ...
			   for($i=0;$i<$num_items; $i++){
				...
				?>
              	...
              	<td class="<?php echo $cl?>">
                	...
                	<?php echo $report->num_credits;  ?> credits</td>
              	</tr>
			<?php }?>			
              <tr>
		...
		<p>
			...
			This transaction requires <?php echo $total_credits_required?> credits.
	 		<a class="ignore_jssm" href="bulk-reverse-whois-order.php" style="color:red;font-weight:bold;"> 
	  		Click here to order more Reverse whois reports(credits) in Bulk for as low as $<?php echo $lowestPricePerReport;?> per report (credit)!</a> 
	  </p>
	  <?php }
	  	...
	  	<p>
			You currently have <?php echo $credits_before_purchase?> credits.  
	 		...
	 		<a class="ignore_jssm" href='<?php echo "$app_root/bulk-reverse-whois-order.php"?>' style="color:red;font-weight:bold;">
	  			Click here to order more Reverse whois report credits in Bulk for as low as $<?php echo $lowestPricePerReport;?> per credit!</a> 
	  	</p>
