...
var supports_onhashchange = false;
var jssm = {
	...
	*/
	init: function (type) {
		...
		//console.log('bind hashchange event');
	...
	*/
	poll: function () {
		...
		if (jssm.getHash() != jssm.stack[jssm.pointer]) {
			//console.log('trigger hashchange ',jssm.getHash(), jssm.stack[jssm.pointer]);
			//console.log(supports_onhashchange);
			if(supports_onhashchange==false)jQuery(window).trigger('hashchange'); //hashchange is already triggered automatically by window event hashchange
