<?php
  ...
  function get_whois_raw($options){ 
	...
	$SQL = sprintf("select w.raw_text as w_raw_text, r.raw_text as r_raw_text from whois_record w, registry_data r where w.registry_data_id = r.registry_data_id and w.domain_name='%s' and w.audit_updated_date =from_unixtime(%d)", $domain_name, $updated_date);
