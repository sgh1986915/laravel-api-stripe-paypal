...
//$q = "select * from whois_current_index w inner join (select domain_id,max(audit_updated_date) from whois_current_index where match('@domain_name test.com') group by domain_id) as w2 on w.domain_id=w2.domain_id and w.audit_updated_date=w2.audit_updated_date;";
//$q="select domain_id,max(audit_updated_date) from whois_current_index where match('@domain_name test.com') group by domain_id";
$q="test.com";
$sql = "";
$mode = SPH_MATCH_ALL;
$host = "74.63.238.138";
$port = 9314;
$index = "whois_current_index";
$groupby = "";
